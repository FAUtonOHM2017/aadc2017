...
class TROI:
  ...
  thrift_spec = (
    ...
    (3, TType.I16, 'width', None, None, ), # 3
    (4, TType.I16, 'height', None, None, ), # 4
    (5, TType.STRING, 'name', None, None, ), # 5
  )

  def __init__(self, x=None, y=None, width=None, height=None, name=None,):
    self.x = x
    self.y = y
    self.width = width
    self.height = height
  ...
  def write(self, oprot):
    ...
    if self.width is not None:
      oprot.writeFieldBegin('width', TType.I16, 3)
      oprot.writeI16(self.width)
      oprot.writeFieldEnd()
    if self.height is not None:
      oprot.writeFieldBegin('height', TType.I16, 4)
...
class TDataRaw:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'rois', (TType.STRUCT,(TROI, TROI.thrift_spec)), None, ), # 2
  )

  def __init__(self, raw_data=None, rois=None,):
  ...
  def write(self, oprot):
    ...
    if self.rois is not None:
      oprot.writeFieldBegin('rois', TType.LIST, 2)
      oprot.writeListBegin(TType.STRUCT, len(self.rois))
      for iter6 in self.rois:
        iter6.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def validate(self):
    ...
    if self.rois is None:
      raise TProtocol.TProtocolException(message='Required field rois is unset!')
    return
...
class TDataClassification:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TDataClassification')
...
class TDataResult:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'roi', (TROI, TROI.thrift_spec), None, ), # 1
    (2, TType.LIST, 'results', (TType.STRUCT,(TDataClassification, TDataClassification.thrift_spec)), None, ), # 2
  )

  def __init__(self, roi=None, results=None,):
    self.roi = roi
  ...
  def validate(self):
    if self.roi is None:
      raise TProtocol.TProtocolException(message='Required field roi is unset!')
